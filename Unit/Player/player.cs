...
public class player : MonoBehaviour {
    ...
    void fs_control()
    {
        if (Input.GetKey(KeyCode.W)||BehaviorKind == 0||BehaviorKind==4||BehaviorKind==5)
        {
            speed = 1;
            Ispeed = this.transform.GetComponent<Self_class>().s_speed;
        }
        else if (Input.GetKey(KeyCode.S) || BehaviorKind == 1 || BehaviorKind == 6 || BehaviorKind == 7)
        {
            speed = 1;
            Ispeed = -this.transform.GetComponent<Self_class>().s_speed;
        }
        ...
        if (Input.GetKey(KeyCode.D) || BehaviorKind == 2 || BehaviorKind == 4 || BehaviorKind == 6)
        {
            cplayer.Rotate(-Vector3.down * 120 * Time.deltaTime);
        }
        else if(Input.GetKey(KeyCode.A) || BehaviorKind == 3 || BehaviorKind == 5 || BehaviorKind == 7)
        {
        ...
        if (Input.GetKeyDown(KeyCode.I))
        {
            ...
            this.transform.GetComponent<Self_class>().s_Defence += 200;
            this.transform.GetComponent<Self_class>().s_AttackValue += 30;
        }
